...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reading.location_accuracy'
        db.add_column('readings_reading', 'location_accuracy',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Reading.reading_accuracy'
        db.add_column('readings_reading', 'reading_accuracy',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reading.location_accuracy'
        db.delete_column('readings_reading', 'location_accuracy')

        # Deleting field 'Reading.reading_accuracy'
        db.delete_column('readings_reading', 'reading_accuracy')
