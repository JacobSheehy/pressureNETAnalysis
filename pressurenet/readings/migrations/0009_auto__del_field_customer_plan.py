...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.plan'
        db.delete_column('readings_customer', 'plan_id')


    def backwards(self, orm):
        # Adding field 'Customer.plan'
        db.add_column('readings_customer', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['readings.CustomerPlan']),
                      keep_default=False)
