...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reading.provider'
        db.add_column('readings_reading', 'provider',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Reading.observation_type'
        db.add_column('readings_reading', 'observation_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Reading.observation_unit'
        db.add_column('readings_reading', 'observation_unit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reading.provider'
        db.delete_column('readings_reading', 'provider')

        # Deleting field 'Reading.observation_type'
        db.delete_column('readings_reading', 'observation_type')

        # Deleting field 'Reading.observation_unit'
        db.delete_column('readings_reading', 'observation_unit')
