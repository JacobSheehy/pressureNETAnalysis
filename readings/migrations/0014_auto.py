...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Reading', fields ['daterecorded']
        db.create_index('readings_reading', ['daterecorded'])

        # Adding index on 'Reading', fields ['longitude']
        db.create_index('readings_reading', ['longitude'])

        # Adding index on 'Reading', fields ['latitude']
        db.create_index('readings_reading', ['latitude'])


    def backwards(self, orm):
        # Removing index on 'Reading', fields ['latitude']
        db.delete_index('readings_reading', ['latitude'])

        # Removing index on 'Reading', fields ['longitude']
        db.delete_index('readings_reading', ['longitude'])

        # Removing index on 'Reading', fields ['daterecorded']
        db.delete_index('readings_reading', ['daterecorded'])
