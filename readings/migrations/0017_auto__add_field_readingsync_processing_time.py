...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReadingSync.processing_time'
        db.add_column('readings_readingsync', 'processing_time',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReadingSync.processing_time'
        db.delete_column('readings_readingsync', 'processing_time')
