...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReadingSync'
        db.create_table('readings_readingsync', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('readings', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('readings', ['ReadingSync'])


    def backwards(self, orm):
        # Deleting model 'ReadingSync'
        db.delete_table('readings_readingsync')
