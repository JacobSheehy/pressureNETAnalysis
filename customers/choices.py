...
CUSTOMER_FORM_TYPES = (
    (CUSTOMER_RESEARCHER, 'Researcher', 'Currently, researchers receive our hourly, global data at no charge. You must be researching at an academic institution to qualify.'),
