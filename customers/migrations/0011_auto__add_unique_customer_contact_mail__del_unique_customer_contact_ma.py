...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Customer', fields ['contact_mail']
        db.delete_unique(u'customers_customer', ['contact_mail'])

        # Adding unique constraint on 'Customer', fields ['contact_mail', 'contact_name', 'company_name']
        db.create_unique(u'customers_customer', ['contact_mail', 'contact_name', 'company_name'])
