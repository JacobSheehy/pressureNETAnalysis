...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'customers_customerplan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('global_calls', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('region_calls', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('regions', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('price', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'customers', ['CustomerPlan'])


    def backwards(self, orm):
        # Deleting model 'CustomerPlan'
        db.delete_table(u'customers_customerplan')
