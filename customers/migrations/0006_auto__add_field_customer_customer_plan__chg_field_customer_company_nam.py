...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.customer_plan'
        db.add_column(u'customers_customer', 'customer_plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.CustomerPlan'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Customer.company_name'
        db.alter_column(u'customers_customer', 'company_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Customer.customer_plan'
        db.delete_column(u'customers_customer', 'customer_plan_id')


        # Changing field 'Customer.company_name'
        db.alter_column(u'customers_customer', 'company_name', self.gf('django.db.models.fields.CharField')(default='Public', max_length=255))
