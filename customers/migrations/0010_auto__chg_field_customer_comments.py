...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.comments'
        db.alter_column(u'customers_customer', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Customer.comments'
        db.alter_column(u'customers_customer', 'comments', self.gf('django.db.models.fields.TextField')(default=''))
