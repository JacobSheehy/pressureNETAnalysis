...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerPlan.description'
        db.add_column(u'customers_customerplan', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerPlan.description'
        db.delete_column(u'customers_customerplan', 'description')
