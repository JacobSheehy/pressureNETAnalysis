...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.api_key_enabled'
        db.add_column(u'customers_customer', 'api_key_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.api_key_enabled'
        db.delete_column(u'customers_customer', 'api_key_enabled')
