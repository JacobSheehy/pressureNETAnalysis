...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('customers_customer', 'customer_type', self.gf('django.db.models.fields.CharField')(default='public', max_length=20))

    def backwards(self, orm):

        # Changing field 'Customer.customer_type'
        db.alter_column('customers_customer', 'customer_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
