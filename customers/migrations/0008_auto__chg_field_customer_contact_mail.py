...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.contact_mail'
        db.alter_column(u'customers_customer', 'contact_mail', self.gf('django.db.models.fields.EmailField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Customer.contact_mail'
        db.alter_column(u'customers_customer', 'contact_mail', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        u'customers.customer': {
            ...
            'contact_mail': ('django.db.models.fields.EmailField', [], {'max_length': '100'}),
