...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCallLog.path'
        db.add_column('customers_customercalllog', 'path',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'CustomerCallLog.query'
        db.add_column('customers_customercalllog', 'query',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCallLog.path'
        db.delete_column('customers_customercalllog', 'path')

        # Deleting field 'CustomerCallLog.query'
        db.delete_column('customers_customercalllog', 'query')
