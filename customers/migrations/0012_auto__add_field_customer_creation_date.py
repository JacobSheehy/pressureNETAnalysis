...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.creation_date'
        db.add_column(u'customers_customer', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.creation_date'
        db.delete_column(u'customers_customer', 'creation_date')
